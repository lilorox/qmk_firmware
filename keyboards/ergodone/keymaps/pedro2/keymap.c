...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_NO,   KC_GRV,  KC_LCBR, KC_RCBR, KC_EXLM, KC_AMPR, KC_F12,
                KC_TILD, KC_LPRN, KC_RPRN, KC_DLR,  KC_ASTR, KC_NO,
       KC_NO,   KC_PIPE, KC_LBRC, KC_RBRC, KC_HASH, KC_CIRC, KC_NO,
                         KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
       KC_TRNS, VRSN,
       KC_NO,
       KC_NO,   KC_NO, KC_NO
...
[MDIA] = LAYOUT_ergodox(
       ...
       KC_VOLU, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, KC_NO, KC_NO,
       KC_VOLD, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
